...
const Create = ({ user, closeModal, update, post }) => {
  const [selectedFile, setSelectedFile] = useState(
    update ? post.imageUrl : null
  );
  const fileInputRef = useRef(null);
  const [bFile, setBFile] = useState(false);
  const [caption, setCaption] = useState(update ? post.caption : "");
  const { profile_pic, username, uid } = user || {};
    ...
    >
      ...
      {update ? (
        <>
          ...
          <div className="create-post">
            ...
            <div className="post-content">
              ...
              <div className="post-button" onClick={updateHandler}>
                Update
              </div>
            </div>
            <div
        ...
        <>
          ...
          {bFile ? (
            <div className="create-post">
              <img src={URL.createObjectURL(selectedFile)} alt="Post image" />
              <div className="post-content">
                <div className="user">
                  {profile_pic === "" ? (
                    <PersonRoundedIcon
                ...
                />
                <p>{caption.length}/2000</p>
                <span className="post-button" onClick={shareHandler}>
                  Share
                </span>
              </div>
              <span
