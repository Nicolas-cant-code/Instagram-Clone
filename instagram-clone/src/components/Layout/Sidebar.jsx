  ...
  return (
    <div className="sidebar">
      ...
      <div className="top-sidebar-elements">
        ...
        <div className="side-icons">
          <ExploreIcon className="side-icon" />
          <span className="side-text">Explore</span>
        </div>

        <div className="side-icons">
          <MovieFilterIcon className="side-icon" />
          <span className="side-text">Reels</span>
        </div>

        <div className="side-icons">
          <SendIcon className="side-icon" />
        ...
        <Link to="/profile" className="link">
          <div
            className={`side-icons ${activeIcon === "Profile" ? "active" : ""}`}
            onClick={() => handleIconClick("Profile")}
          >
            <PersonRoundedIcon
              className={`side-icon person
              ${activeIcon === "Profile" ? "person-active" : ""}
            `}
            />
